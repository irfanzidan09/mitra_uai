      ...
      <div class="leftpanelinner">
        ...
        <div class="media leftpanel-profile">
          ...
          <div class="media-body">
            <h4 class="media-heading"><?php echo $this->session->userdata('nama'); ?><a data-toggle="collapse" data-target="#loguserinfo" class="pull-right"><i class="fa fa-angle-down"></i></a></h4>
        ...
        <ul class="nav nav-tabs nav-justified nav-sidebar">
          ...
          <li class="tooltips unread" data-toggle="tooltip" title="" data-original-title="Check Mail"><a data-toggle="tab" data-target="#emailmenu"><i class="tooltips fa fa-envelope" data-original-title="" title=""></i></a></li>
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane active" id="mainmenu">
            ...
            <ul class="nav nav-pills nav-stacked nav-quirk">
              <li class="nav-parent"><a href><i class="fa fa-user"></i> <span>Admin Toko</span></a>
              <ul class="children">
                <li><a href="<?php echo base_url().'admin/data' ?>"><i class="fa fa-book"></i> Data</a></li>
                <li><a href="<?php echo base_url().'admin/tambah' ?>"><span class="glyphicon glyphicon-pencil"></span> Tambah</a></li>
              </ul>
              </li>
              <li class="nav-parent"><a href><i class="fa fa-user"></i> <span>Suplier</span></a>
              <ul class="children">
                <li><a href="<?php echo base_url().'mitra/data' ?>"><i class="fa fa-book"></i> Data</a></li>
                <li><a href="<?php echo base_url().'mitra/tambah' ?>"><span class="glyphicon glyphicon-pencil"></span> Tambah</a></li>
              </ul>
              </li>
              <li class="nav-parent"><a href><i class="fa fa-credit-card"></i></i> <span>PJ Keuangan</span></a>
              <ul class="children">
                <li><a href="<?php echo base_url().'keuangan/data' ?>"><i class="fa fa-book"></i> Data</a></li>
                <li><a href="<?php echo base_url().'keuangan/tambah' ?>"><span class="glyphicon glyphicon-pencil"></span> Tambah</a></li>
              </ul>
              </li>
            </ul>

            <h5 class="sidebar-title">Barang</h5>
            <ul class="nav nav-pills nav-stacked nav-quirk">
              <li><a href="<?php echo base_url().'admin/data_marketing' ?>"><i class="fa fa-cube"></i>&nbsp;Penjualan Barang</a></li>
            ...
            <ul class="list-group list-group-settings">
              <li class="list-group-item">
                ...
                <div class="toggle-wrapper">
                  <div class="leftpanel-toggle toggle-light success" style="height: 22px; width: 50px;"><div class="toggle-slide"><div class="toggle-inner" style="width: 78px; margin-left: 0px;"><div class="toggle-on active" style="height: 22px; width: 39px; text-indent: -11px; line-height: 22px;">ON</div><div class="toggle-blob" style="height: 22px; width: 22px; margin-left: -11px;"></div><div class="toggle-off" style="height: 22px; width: 39px; margin-left: -11px; text-indent: 11px; line-height: 22px;">OFF</div></div></div></div>
                </div>
              </li>
              <li class="list-group-item">
                <h5>Call Phones</h5>
                ...
                <div class="toggle-wrapper">
                  <div class="leftpanel-toggle-off toggle-light success" style="height: 22px; width: 50px;"><div class="toggle-slide"><div class="toggle-inner" style="width: 78px; margin-left: -28px;"><div class="toggle-on" style="height: 22px; width: 39px; text-indent: -11px; line-height: 22px;">ON</div><div class="toggle-blob" style="height: 22px; width: 22px; margin-left: -11px;"></div><div class="toggle-off active" style="height: 22px; width: 39px; margin-left: -11px; text-indent: 11px; line-height: 22px;">OFF</div></div></div></div>
                </div>
              </li>
            </ul>
