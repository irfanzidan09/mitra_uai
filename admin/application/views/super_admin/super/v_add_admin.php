        ...
        <div class="col-sm-12">
          <div class="panel">
            ...
            <div class="panel-body">
               <form class="form-style-1" method="post" action="<?php echo base_url() ?>admin/input">
          ...
          <div class="form-group col-sm-6">
                  ...
                  <div class="form-group col-sm-6">
                    ...
                    <input type="text" required="true" class="form-control" name="no_hp" placeholder="No HP">
                  </div>
                  <div class="form-group col-sm-6">
                    <label for="billingAddress">Nama Ayah</label>
                    <input type="text" required="true" class="form-control" name="nama_ayah" placeholder="Nama Ayah">
                  </div>
                  <div class="form-group col-sm-6">
                    <label for="billingAddress">Nama Ibu</label>
                    <input type="text" required="true" class="form-control" name="nama_ibu" placeholder="Nama Ibu">
                  </div>
                  <div class="form-group col-sm-6 ">
                    <label for="billingCountry">Pendidikan Terakhir</label>
                    <select class="form-control custom-select" required="true" name="pendidikan">
                      <option></option>
                  ...
                  <div class="form-group col-sm-6">
                    ...
                    <input type="text" required="true" class="form-control" name="stifin" placeholder="Hasil Stifin">
                  </div>
                   <div class="form-group col-sm-6">
